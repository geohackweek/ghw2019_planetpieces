...
'''
Adapted from https://developers.planet.com/tutorials/convert-planetscope-imagery-from-radiance-to-reflectance/

Usage: python ~/git_dirs/ghw2019_planetpieces/scripts/toa_calc.py path_to_Analytic.tif
...
parser.add_argument('input_file', help='Planet *Analytic.tif MS image file')
